#
#  Be sure to run `pod spec lint GWPKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "甘文鹏" => "ganwenpeng1993@163.com" }
  # Or just: s.author    = "甘文鹏"
  # s.authors            = { "甘文鹏" => "ganwenpeng1993@163.com" }
  # s.social_media_url   = "http://twitter.com/小甘"
  ...
  s.source       = { :git => "https://github.com/GanWenPeng/GWPKit.git", :tag => s.version }
